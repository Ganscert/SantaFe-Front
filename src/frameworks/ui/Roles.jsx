          ...
          {editing ? (
            <div className="space-y-2">
              <input
                ...
                className="w-full px-3 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 text-sm font-bold focus:outline-none focus:border-[#4F46E5]"
              />
              <input
                value={draft.description}
                onChange={e => setDraft(d => ({ ...d, description: e.target.value }))}
                placeholder="Descripción"
                className="w-full px-3 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-300 text-xs focus:outline-none focus:border-[#4F46E5]"
              />
            </div>
          ) : (
            <>
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-start gap-2.5 px-3 py-2 rounded-xl cursor-pointer transition-colors ${
                        enabled
                          ? 'bg-[#4F46E5]/8 dark:bg-[#4F46E5]/15 ring-1 ring-[#4F46E5]/30'
                          : 'hover:bg-slate-50 dark:hover:bg-slate-800/50'
                      }`}
                    >
                      <input type="checkbox" checked={enabled} onChange={() => onTogglePerm(p.id)} className="mt-0.5 accent-[#4F46E5]" />
  ...
  return (
    <div className="grid grid-cols-[auto_1fr_auto] sm:grid-cols-[auto_1fr_auto_auto_auto] items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
      ...
      <div className="hidden sm:flex items-center gap-1 text-[11px] font-bold text-slate-500 dark:text-slate-400 shrink-0">
        <span className="text-[#4F46E5] dark:text-[#0EA5E9] font-black text-base leading-none">{effective}</span>
      ...
      <div className="flex items-center gap-1 shrink-0">
        <select
          ...
          className="text-xs font-bold px-2 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 focus:outline-none focus:border-[#4F46E5] cursor-pointer max-w-[8rem] sm:max-w-none"
        >
          {roles.map(r => (
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl ring-1 ring-slate-200 dark:ring-slate-800 overflow-hidden max-h-[90vh] flex flex-col">
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3 shrink-0">
          ...
          <div className="hidden sm:flex items-center gap-1 text-[11px] font-bold text-slate-500 dark:text-slate-400">
            <span className="text-[#4F46E5] dark:text-[#0EA5E9] font-black text-lg leading-none">
        ...
        <div className="px-5 py-3 border-t border-slate-100 dark:border-slate-800 flex justify-end shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm font-bold transition-colors"
          >
            Listo
          </button>
        </div>
    ...
    <div className="min-h-screen text-slate-900 dark:text-slate-100 transition-colors">
          ...
          <div className="flex items-center gap-2">
            ...
            {tab === 'roles' && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-white text-xs font-bold transition-colors"
              >
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-5">
        {tab === 'roles' ? (
          <>
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-[#4F46E5] dark:text-[#0EA5E9]">Administración</p>
          ...
          <>
            <div className="flex items-start justify-between gap-3 flex-wrap">
              ...
              <Link
                to="/admin/usuarios"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#4F46E5] hover:bg-[#4338CA] text-white text-xs font-bold transition-colors shrink-0"
              >
                ...
                return (
                  <button
                    ...
                    className={`rounded-2xl px-3 py-2.5 text-left transition-all ring-1 ${
                      active
                        ? 'ring-[#4F46E5] bg-white dark:bg-slate-900 shadow-sm'
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#4F46E5]/30 focus:border-[#4F46E5]"
                />
              </div>
              {userRoleFilter !== 'Todos' && (
                <button
                  ...
                  className="text-xs font-semibold text-slate-500 hover:text-[#4F46E5] inline-flex items-center gap-1 shrink-0"
                >
